require(["activities/settings", "order!jquery", 
         "order!cdn/jquery.tmpl.js"], 
        function(){
            ...
            var action_tmpl = $.template(null, $("#action"));
            ...
            $.extend(activities.ui.Node.prototype, {
                ...
                getCoordinates: function(){
                    return this.model.get("ui_data");
                },

                setCoordinates: function(x, y){
                    if(this.model){
                        this.model.set({ui_data: {x:x,
                                                  y:y}});
                    }
                },
